...
if(preg_match("/^Vocab Stanza/", $LlTeitl)){
  ...
  if(!($rhRhes % 18)){
    ...
    file_put_contents("./siart". sprintf("%02d", $RhRhesi ). ".html", '<!DOCTYPE html><html><head>
      <style>
      .clDydd {font-weight:bold;font-size:150%;margin-bottom:-220px;margin:-20px;text-align:left;transform:rotate(-90deg) translateX(-90px);}
      ...
      <div class="clPeniad">Wythnos '. $RhRhesi .' o 32</div>
