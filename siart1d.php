...
if(preg_match("/^Vocab Stanza/", $LlTeitl)){
  ...
  if(!(($rhRhes-1) % 3)){
    ...
    if($RhDydd == 1){
      $Ll6ol="";
      if($Rh18 == 18){
        $Ll18 .= '<tr><td><div class="clDydd">Llun</div></td>';
      }else {
        if      ($rh6 == 1){
          $Ll6ol="a";
          $Ll18 .= '<tr><td><div class="clDydd">Llun</div></td>';
          ...
          $Ll6ol="b";
          $Ll18 .= '<tr><td><div class="clDydd">Mercher</div></td>';
        }else if($rh6 == 13){
          $Ll6ol="c";
          $Ll18 .= '<tr><td><div class="clDydd">Gwener</div></td>';
        }
      }
    }
    if($RhDydd == 2){
      $Ll6ol="";
      if($Rh18 == 18){
        $Ll18 .= "<tr><td><div class='clDydd'>Mawrth ".  "</div></td>";
      }else {
        if      ($rh6 == 4){
          $Ll6ol="a";
          $Ll18 .= '<tr><td><div class="clDydd">Mawrth</div></td>';
          ...
          $Ll6ol="b";
          $Ll18 .= '<tr><td><div class="clDydd">Iau</div></td>';
        }else if($rh6 == 16){
          $Ll6ol="c";
          $Ll18 .= '<tr><td><div class="clDydd">Sadwrn</div></td>';
        }
      }
    }
    if($RhDydd == 3){
//echo "2________Merch>>>". $rhRhes."\n";
      $Ll18 .= "<tr><td><div class='clDydd'>Mercher ". "</div></td>";
    }
    if($RhDydd == 4){
//echo "2________Iau___________>>>". $rhRhes."\n";
       $Ll18 .= "<tr><td><div class='clDydd'>Iau ".     "</div></td>";
    }
    if($RhDydd == 5){ 
//echo "2________Gwen___________>>>". $rhRhes."\n";
      $Ll18 .= "<tr><td><div class='clDydd'>Gwener ".  "</div></td>";
    }
    if($RhDydd == 6){ 
//echo "2________Sad___________>>>". $rhRhes."\n";
      $Ll18 .= "<tr><td><div class='clDydd'>Sadwrn ".  "</div></td>";
    }
  }
  ...
  if(!($rhRhes % $Rh18)){
    $RhRhesi++;
    if($Rh18 == 6){
      $rhRhesi=((int)(($RhRhesi +2)/3));
    }else {
      $rhRhesi=$RhRhesi;
    }
 
    echo sprintf("%02d",$rhRhesi). $Ll6ol."/32___________________________\n";
    file_put_contents("./siart". sprintf("%02d", $rhRhesi ). $Ll6ol. ".html", '<!DOCTYPE html><html><head>
      <style>
      ...
      <div class="clPeniad">Beginner-1 Sylfaenol &ensp;-&ensp; Wythnos '. $rhRhesi . $Ll6ol.' o 32 &ensp;-&ensp; Learn Welsh Rhagori yn Gymraeg</div>
