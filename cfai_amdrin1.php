...
//echo $ll1a."\n";
    ...
    //if( (substr($ll1a,0,7) =="|ffeil=") || (substr($ll1a,0,11)=="|=====") ){
...
file_put_contents("./0rhestr", $LlRhestr);
...
foreach($dLlNewydd as $l1a){
  $l1a = trim($l1a);
  if($l1a == "") continue;
  if(isset($DGeirfaCym[$l1a])) {
     echo trim($l1a);
     echo "_".$DGeirfaCym[$l1a];
     echo "` ";
  }else {
     echo "_ ";
     echo strtoupper($l1a);
